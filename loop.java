...
public class Loop
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Finding all occurrences in array 2....");
		FindOccurencesOfNumberInArray(array2, 60);
		System.out.println("Finding all occurrences in array 3....");
	...
	public static void FindOccurencesOfNumberInArray(int[] numbers, int searchNumber)
	{
		if (numbers != null)
		{
			...
			System.out.println(searchNumber + " was found " + countOfOccurences + " times in array");
